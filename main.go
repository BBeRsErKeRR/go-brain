...
import (
	...
	"github.com/bberserkerr/go-brain/brain/adapters/logger"

	"github.com/bberserkerr/go-brain/brain/adapters/ansibleinventory"
)
...
func main() {
	...
	inv, err := ansibleinventory.NewCMDAnsibleInventory(context.Background(), logg, []string{"localhost,"}, "", "")
	if err != nil {
		log.Panic(err)
	}
	fmt.Printf("Current struct:\n %s", inv)
}
